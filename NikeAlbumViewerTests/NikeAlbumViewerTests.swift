...
class NikeAlbumViewerTests: XCTestCase {
    ...
    func testJSONdecoder() {
        ...
        do {
            ...
            do {
                let rss = try JSONDecoder().decode(NARSS.self, from: json.data(using: .utf8)!)
                ...
                XCTAssert(albums[0].storeUrl == URL(string: "https://itunes.apple.com/us/album/swervo/1413595651?app=music"))
                XCTAssert(albums[0].artworkUrl == URL(string: "https://is2-ssl.mzstatic.com/image/thumb/Music118/v4/0a/06/a2/0a06a23f-468d-78a8-ee3e-ef16e420f1f3/contsched.twcnaiog.jpg/200x200bb.png"))
                ...
                XCTAssert(albums[1].storeUrl == URL(string: "https://itunes.apple.com/us/album/queen-naija-ep/1413905925?app=music"))
                XCTAssert(albums[1].artworkUrl == URL(string: "https://is2-ssl.mzstatic.com/image/thumb/Music118/v4/95/c0/65/95c06543-1926-1086-f213-7863d4f5bc10/00602567799870.rgb.jpg/200x200bb.png"))
                ...
                XCTAssert(albums[2].storeUrl == URL(string: "https://itunes.apple.com/us/album/beastmode-2/1407068657?app=music"))
                XCTAssert(albums[2].artworkUrl == URL(string: "https://is2-ssl.mzstatic.com/image/thumb/Music115/v4/0f/41/7b/0f417b33-e253-d088-aa1a-1e441a3bea0f/886447204764.jpg/200x200bb.png"))
